(function ($) {
	...
	jQuery('.bs-docs-sidenav li:first-child').addClass('active');
	//scroll menu
	jQuery('.appear').appear();
	jQuery(".appear").on("appear", function(data) {
			var id = $(this).attr("id");
			jQuery('.bs-docs-sidenav li').removeClass('active');
			jQuery(".bs-docs-sidenav a[href='#" + id + "']").parent().addClass("active");
	});
